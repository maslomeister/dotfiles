...
--Changes are recommended to be made in the script-opts directory.
	...
	startup_idle_behavior = 'resume', --The behavior when mpv launches and nothing is loaded. 'none' for disabled. 'resume' to automatically resume your last played item. 'resume-notime' to resume your last played item but starts from the beginning.
	...
	resume_option = 'force', --'none': for disabled. 'notification': a message to resume the previous reached time will be triggered. 'force': to forcefully resume last playback based on threshold
